...
def main():
    ...
    create_csv("[Score Distribution] - Mathematics", list(math_dis_data.keys()), math_dis_data, math_list)
    create_csv("[Score Distribution] - Reading", list(read_dis_data.keys()), read_dis_data, read_list)
    create_csv("[Score Distribution] - Science", list(sci_dis_data.keys()), sci_dis_data, sci_list)
    print("Sucessfully create CSV !!")

def create_csv(name, key, dis_data, row_list):
    """ Create New CSV """
